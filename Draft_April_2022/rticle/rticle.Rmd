---
title: |
  "How has the Brazilian Amazon been constructed as a problem? An analysis of presidential speeches since 1985"
type: ARTICLE TEMPLATE
author:
  - name: Livio Silva-Muller
    affil: Graduate Institute of International and Development Studies
    email: livio.silva@graduateinstitute.ch
  - name: Henrique Sposito
    affil: Graduate Institute of International and Development Studies
    email: henrique.sposito@graduateinstitute.ch
affiliation:
  - num: Graduate Institute of International and Development Studies
    address: |
...
```{r codebook, echo=FALSE, message=FALSE, warning=FALSE, out.width="90%", paged.print=TRUE, include=TRUE}
...
```{r Figure 4: mixed-types by president, echo=FALSE, out.width="90%", message=FALSE, warning=FALSE, paged.print=FALSE, include=TRUE}
comp_types <- ama_mx %>%
...
```{r multimonial model, echo=FALSE, message=FALSE, out.width="90%", warning=FALSE, paged.print=FALSE, include=TRUE}
