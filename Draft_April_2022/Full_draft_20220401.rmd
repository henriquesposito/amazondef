...
kbl(codebook, booktabs = T,caption = "Table 1 - Amazonian Problem-Construction Codebook")%>% kable_styling(latex_options = c("striped", "repeat_header", "scale_down"), position= "center", font_size = 9, full_width = TRUE) %>%
...
md <- tibble("Dependent Variable" = c("Economic Integration vs Environmental Conservation",
                 ...
                 "Other States vs Amazonian States" = c("0.023", "-0.041", "0.324"),
                 "Election Year" = c("-0.241", "0.028", "-0.684**"),
                 "Annual Deforestation" = c("0.063***", "-0.031*", "0.004"),
                 "Average Inflation" = c("-0.001***", "-0.001***", "-0.0001"))

kbl(t(md), booktabs = T,caption = "Table 2 - Amazon Problem-Construction by Location", align = "c")%>% kable_styling(latex_options = c("striped", "scale_down"), position= "center", font_size = 9, full_width = TRUE) %>%
...
Accuracy AUC False Positives 0.946 0.69 Sovereignty 0.866 0.59 Economic Integration 0.678 0.68 Social Development 0.792 0.66 Conservation 0.802 0.78
