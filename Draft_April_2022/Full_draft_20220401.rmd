...
codebook <- tibble::tibble('Problem Construction' = c("National Sovereignty", "Economic Integration",
                           ...
                           Example = c("We can now walk the world and when we debate about the Amazon, we do not need to wait for questions, we are the ones who are going to say what we are doing in the Amazon. We do not need to keep on saying ‘the Amazon is ours’ just for saying it, people often say this without much conviction either. If the Amazon has been ours since Cabral (European discoverer of Brazil) stepped here, why do we now have to worry about the Amazon? (Lula 2008)", "", "", ""))
