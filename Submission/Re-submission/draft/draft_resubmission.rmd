...
```{r Figure pure, fig.cap="Pure-types and miyed-types in time", echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, include=TRUE}
...
ama_mx %>%
  ...
  labs(x = "", y = "", title ="Share of pure-types and mixed-types problem-constructions by year",
...
```{r log odds, fig.cap = "Odds-ration for fixed-effects logistic regressions indexed by president", echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, include=TRUE, results="asis"}
