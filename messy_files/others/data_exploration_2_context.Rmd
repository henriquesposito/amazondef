...
# In case you want to sample a few random text observations by president
# sample_pres <- Amazon_speeches %>% group_by(president) %>% sample_n(8) %>% select(president, year, ccontext)

# Create a little frequencies data frame
...
# Simple plot of the frequency of speeches that mention Amazon since 1985
...
Amazon_speeches$text <- tm::removeWords(Amazon_speeches$text,
                                        c(tm::stopwords("pt"), "nao", "amazonas",
                                          ...
                                          "antonio", "vou", "eduardo braga",
                                          "então", "pouco", "pode", "sul", "norte", 
