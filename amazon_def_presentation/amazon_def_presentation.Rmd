...
#How research get's made

** Let's take a look under the hood**

- Collaborating in R with [GitHub](https://github.com/henriquesposito/amazondef)

- This [presentation](https://github.com/henriquesposito/amazondef/tree/main/amazon_def_presentation)

- This [article](https://github.com/henriquesposito/amazondef/tree/main/Draft_September_2022)
...
- Introduce, define, and justify public policy `r Cite(myBib, "zarefsky2004")`

- Shape perception and expectation about practices; important for deforestation `r Cite(myBib, c("capobianco2021", "campbell2015"))`
...
- Discursive problems and solutions are shaped by history and culture `r Cite(myBib, "bacchi2009")`

- *But policymakers can choose to emphasize problems that a policy solves depending who they are in communication with...*
...
##The Amazon in presidential speeches

.center[
```{r Figure 1, echo=FALSE, message=FALSE, warning=FALSE, paged.print=TRUE, include=TRUE, fig.height=7, fig.width=14}
perc1 <- pop %>%
...
##The Amazon as a *pure* problem

.center[
```{r Figure 2, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, include=TRUE, fig.height=7, fig.width=14}
mmt1 <- ama_mx %>%
...
##The Amazon as a *mixed* problem

.center[
```{r Figure 3, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, include=TRUE, fig.height=7, fig.width=14}
...
##The Amazon multi-level game: talking to people inside?

.center[
```{r Figure 4, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, include=TRUE, fig.height=7, fig.width=14}
...
stargazer::stargazer(model_logit_con2, model_logit_ei2, model_logit_sd2,
                          model_logit_sov2, type = "html", digits = 6, 
...
A framework that connects the social construction of the Amazon to environmental outcomes

##Empirically

The first comprehensive overview of the Amazon as a problem in presidential discourse

]

.pull-right[

![:scale 200%](assets/Images/photolivio.png)
]
