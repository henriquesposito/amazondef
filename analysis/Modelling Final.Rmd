...
average_inflation_year_BR <- read_excel("data/average_inflation_year_BR.xlsx") # source world bank
ama_model2 <- dplyr::left_join(ama_model2, average_inflation_year_BR, by = "year") # merge
