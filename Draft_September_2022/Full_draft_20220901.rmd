...
def_rates <- ggplot(amazon_def_year, aes(x = year)) +
  ...
  annotate("text", x = 2004, y = 29000, label = "2004 Plan to Combat\nand Control Deforestation", size = 4.5) +
  annotate("text", x = 2012.5, y = 3500, label = "2012 Forest Code ", size = 4.5) +
  labs(x = "",
     y = "Deforestation in squared kilometers",
