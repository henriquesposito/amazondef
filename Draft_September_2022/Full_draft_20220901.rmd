...
Amazon_year <- perc1 %>% ggplot(., aes(x = year, y = perc)) +
  ...
  annotate("text", x = 2019, y = 0.26, label = "2019 Record August Fires", size=3) +
  labs(x = "", y = "",
...
all_loc <- ggplot(plot_loc, aes(x = km_to_manaus, y=pred, color=p_c)) +
  ...
  labs(x = "Distance from the Amazon (km)",
       y = "",
       title = "Predicted share of each problem-construction as a function of\ndistance from the Amazon",
...
The authors are extremely grateful to Graziella Moraes Silva and James Hollway for their support. The authors would also like to thank Matias, Federico, Rodrigo, and Anna for valuable comments on earlier drafts of this paper.
