...
Amazon_year <- perc1 %>% ggplot(., aes(x = year, y = perc)) +
  ...
  annotate("text", x = 2019, y = 0.26, label = "Red Sky afternoon \n in Sao Paulo", size=3) +
  labs(x = "", y = "",
...
```{r Table 2, fig.cap="Percent of problem constructions across locations", echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, include=TRUE}
