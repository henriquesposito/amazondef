...
# Load data
# Add a footnote about 1992 missing obs
...
Amazon_year <- perc1 %>% ggplot(., aes(x = year, y = perc)) +
  ...
  geom_vline(xintercept = c(1988.9, 1992, 2009, 2015),
             linetype = "dotted") +
