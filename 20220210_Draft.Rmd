...
- operationalize 1st version of new dictionary.docx.
- solve broader problems mentioned in new dictionary.docx.
- spread context and classify based in new dictionary -> new iteration of random_sample and dictionary improvement at observation=one context level
...
development <- ("estrada|rodovia|hidroeletrica|desenvolv|balbina|itaipu|incentivos fiscais| integra|zona franca|transamazonica|madeira|porto|madeireira|produz|energia|agro|agri")

conservation <- ("preserv|conserv|determinacao|povos indigenas|indigenas|direitos humanos|areas demarcadas|queimada|sustentav|meio ambiente|florest|cooperaçao|protecao|proteg")
